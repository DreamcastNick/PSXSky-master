...
static const CharFrame char_xmasp_frame[] = {
	{XmasP_ArcMain_Idle0, {0,   0, 219, 256}, {205, 210}}, //0 idle 1
	{XmasP_ArcMain_Idle1, {0,   0, 219, 256}, {205, 210}}, //1 idle 2
	{XmasP_ArcMain_Idle2, {0,   0, 221, 256}, {205, 210}}, //2 idle 3
	{XmasP_ArcMain_Idle3, {0,   0, 217, 256}, {205, 210}}, //3 idle 4
	
	{XmasP_ArcMain_LeftA0, {0,   0, 197, 256}, {205, 210}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 201, 256}, {205, 210}}, //5 left a 2
	{XmasP_ArcMain_LeftB0, {0,   0, 197, 256}, {205, 210}}, //6 left b 1
	{XmasP_ArcMain_LeftB1, {0,   0, 201, 256}, {205, 210}}, //7 left b 2
	
	{XmasP_ArcMain_DownA0, {0,   0, 213, 256}, {205, 210}}, //8 down a 1
	{XmasP_ArcMain_DownA1, {0,   0, 213, 256}, {205, 210}}, //9 down a 2
	{XmasP_ArcMain_DownB0, {0,   0, 213, 256}, {205, 210}}, //10 down b 1
	{XmasP_ArcMain_DownB1, {0,   0, 213, 256}, {205, 210}}, //11 down b 2
	
	{XmasP_ArcMain_UpA0, {0,   0, 199, 256}, {205, 210}}, //12 up a 1
	{XmasP_ArcMain_UpA1, {0,   0, 201, 256}, {205, 210}}, //13 up a 2
	{XmasP_ArcMain_UpB0, {0,   0, 197, 256}, {205, 210}}, //14 up b 1
	{XmasP_ArcMain_UpB1, {0,   0, 201, 256}, {205, 210}}, //15 up b 2
	
	{XmasP_ArcMain_RightA0, {0,   0, 239, 256}, {205, 210}}, //16 right a 1
	{XmasP_ArcMain_RightA1, {0,   0, 239, 256}, {205, 210}}, //17 right a 2
	{XmasP_ArcMain_RightB0, {0,   0, 239, 256}, {205, 210}}, //18 right b 1
	{XmasP_ArcMain_RightB1, {0,   0, 239, 256}, {205, 210}}, //19 right b 2
};
