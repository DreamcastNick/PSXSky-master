	...
	switch (exec_page = menu.page)
	{
		case MenuPage_Opening:
		{
			...
			else
			{
				...
				//Fallthrough
					case 14:
						menu.font_bold.draw(&menu.font_bold, "SKY", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 8, FontAlign_Center);
				//Fallthrough
					case 13:
						menu.font_bold.draw(&menu.font_bold, "PSX PORT", SCREEN_WIDTH2, SCREEN_HEIGHT2 - 24, FontAlign_Center);
						break;
				}
				break;
			}
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "SKY", {"WIFE FOREVER", "SKY", "MANIFEST"}},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Kapi_2, "   VS SKY PORT", false},				
